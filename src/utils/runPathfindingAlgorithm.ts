...
import { dijikstra } from "../lib/algorithms/pathfinding/dijkstra";
import { AlgorithmType, GridType, TileType } from "./types"

export const runPathfindingAlgorithm = ({algorithm,grid,startTile,endTile}:{
    ...
    switch(algorithm){
        ...
        case "DIJKSTRA":
            return dijikstra(grid,startTile,endTile);
        case "A_STAR":
