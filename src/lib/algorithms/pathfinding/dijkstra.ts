...
import { dropFromQue, isEqual } from "../../../utils/helpers";
import { GridType, TileType } from "../../../utils/types";

export const dijikstra = (grid:GridType,startTile:TileType,endTile:TileType)=>{
        ...
        if(currentTile){
            ...
            for(let i=0;i<neighbors.length;i++){
                if(currentTile.distance+1<neighbors[i].distance){
                    dropFromQue(neighbors[i],unTraversedTiles);
